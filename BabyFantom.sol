...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public minDistribution = 1 * (10**18); // 1 FTM minimum auto send
    uint256 public minimumTokenBalanceForDividends = 2550000 * (10**9); // user must hold 2550000 token
...
contract BFTM is
    BASEToken("Baby Fantom", "BFTM", 25500000000 * (10**9), 9),
    SafeToken,
    LockToken
{
    using SafeMath for uint256;
